    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 animate-fadeIn">
        ...
        <div className="flex flex-col space-y-6">
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h2 className="text-lg font-bold text-gray-900">OPTION A: INTERNAL HEAVY</h2>
                <div className="mt-4 space-y-4">
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <span className="text-sm font-medium">● Internal: 6,00,000 units</span>
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <span className="text-sm font-medium">● Outsourced: 1,00,000 units</span>
                    ...
                    <div className="pt-4 flex items-center justify-between">
                        <span className="text-base font-semibold">Peak Capacity: <span className="text-yellow-500">95% ⚠️</span></span>
                        <span className="text-sm text-gray-500">5 months production</span>
                    </div>
                </div>
            </div>

            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-base font-semibold text-gray-900 mb-4">Capacity Impact (6 Months)</h3>
                <div className="h-60">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-base font-semibold text-gray-900">Option A: Cost Analysis</h3>
                <div className="mt-4 space-y-4">
                    <div className="flex justify-between border-b pb-2">
                        <span>Internal</span>
                        <span className="font-mono text-green-600">₹48,00,000</span>
                    </div>
                    <div className="flex justify-between border-b pb-2">
                        <span>Outsourced</span>
                        <span className="font-mono">₹9,60,000</span>
                    </div>
                    <div className="flex justify-between items-baseline mt-1">
                        <span className="text-base font-bold">TOTAL COST:</span>
                        <span className="text-2xl font-bold text-gray-900">₹57,60,000</span>
                    </div>
                    <div className="text-center p-2 bg-green-50 rounded-md text-green-600 font-medium text-sm">
                        💰 Lowest Cost Option
                    </div>
                </div>
            </div>

            <button className="w-full h-12 bg-blue-600 text-white font-medium rounded-lg shadow hover:bg-blue-700 transition-colors">
        ...
        <div className="flex flex-col space-y-6">
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h2 className="text-lg font-bold text-gray-900">OPTION B: BALANCED</h2>
                <div className="mt-4 space-y-4">
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <span className="text-sm font-medium">● Internal: 4,00,000 units</span>
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <span className="text-sm font-medium">● Outsourced: 3,00,000 units</span>
                    ...
                    <div className="pt-4 flex items-center justify-between">
                        <span className="text-base font-semibold">Peak Capacity: <span className="text-green-500">85% ✅</span></span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-base font-semibold text-gray-900">Option B: Cost Analysis</h3>
                <div className="mt-4 space-y-4">
                    <div className="flex justify-between border-b pb-2">
                        <span>Internal</span>
                        <span className="font-mono text-green-600">₹32,64,000</span>
                    </div>
                    <div className="flex justify-between border-b pb-2">
                        <span>Outsourced</span>
                        <span className="font-mono text-yellow-600">₹26,40,000</span>
                    </div>
                    <div className="flex justify-between items-baseline mt-1">
                        <span className="text-base font-bold">TOTAL COST:</span>
                        <span className="text-2xl font-bold text-gray-900">₹59,04,000</span>
                    </div>
                    <div className="text-center p-2 bg-yellow-50 rounded-md text-yellow-600 font-medium text-sm">
    ...
    <div className="grid grid-cols-1 gap-6 animate-fadeIn">
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div className="flex justify-between items-center mb-6">
                ...
                <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-bold">UPDATED 2 MINS AGO</span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                    ...
                    <div key={i} className="p-4 border rounded-lg flex flex-col items-center text-center">
                        <Package className={`w-8 h-8 text-${item.color}-500 mb-2`} />
                        <div className="text-2xl font-bold text-gray-900">{item.qty}</div>
                        <div className="text-sm text-gray-500">{item.name}</div>
                        <div className={`mt-2 text-xs font-bold px-2 py-1 rounded bg-${item.color}-50 text-${item.color}-700`}>
                            {item.status}
                        </div>
                    </div>
                ))}
...
const RMPlanningView = () => (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeIn">
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Raw Material Requirements (VivaLife Order)</h2>
            <ul className="space-y-4">
                <li className="flex justify-between items-center p-3 bg-gray-50 rounded">
                    ...
                    <span className="font-mono text-blue-600">14,500 Liters</span>
                </li>
                <li className="flex justify-between items-center p-3 bg-gray-50 rounded">
                    <span className="font-medium">Cornstarch Powder</span>
                    <span className="font-mono text-blue-600">850 kg</span>
                </li>
                <li className="flex justify-between items-center p-3 bg-gray-50 rounded">
                    <span className="font-medium">Packing Boxes (50s)</span>
                    <span className="font-mono text-blue-600">14,000 Units</span>
                </li>
            </ul>
        </div>
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 flex flex-col justify-center items-center">
            <Truck className="w-16 h-16 text-gray-300 mb-4" />
            <h3 className="text-lg font-semibold text-gray-900">Supplier Delivery Schedule</h3>
            <p className="text-sm text-gray-500 text-center mt-2">Next shipment of Latex arriving <br /> <span className="font-bold text-gray-900">Tomorrow, 10:00 AM</span></p>
        </div>
    </div>
);
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 animate-fadeIn">
            ...
            <div className="flex justify-between items-end mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Rack Unit: R-204 • Type: Heavy Duty Pallet</p>
                </div>
                <div className="flex space-x-4 text-sm">
                    <div className="text-center">
                        <span className="block font-bold text-xl text-gray-900">75%</span>
                        <span className="text-gray-500 text-xs">Utilization</span>
                    </div>
                    <div className="text-center">
                        <span className="block font-bold text-xl text-blue-600">6/8</span>
...
const JobPlanningView = () => (
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 animate-fadeIn">
        <h2 className="text-lg font-bold text-gray-900 mb-4">Active Job Cards</h2>
        <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-gray-100">
                    <tr>
                        <td className="p-3 font-mono">#JOB-2024-88</td>
                        <td className="p-3">MediCare Inc</td>
                        <td className="p-3">Line A</td>
                        <td className="p-3"><span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-bold">RUNNING</span></td>
                        <td className="p-3 text-right">45%</td>
                    </tr>
                    <tr>
                        <td className="p-3 font-mono">#JOB-2024-89</td>
                        <td className="p-3">Global Health</td>
                        <td className="p-3">Line B</td>
                        <td className="p-3"><span className="px-2 py-1 bg-yellow-100 text-yellow-700 rounded text-xs font-bold">SETUP</span></td>
...
const ProcessLinesView = () => (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeIn">
        {[
            ...
            <div key={idx} className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 relative overflow-hidden">
                <div className={`absolute top-0 right-0 p-4`}>
                    <Activity className={`w-8 h-8 text-${line.color}-500 opacity-20`} />
                </div>
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-bold text-gray-900">{line.id}


                    </h2>
                    <span className={`px-3 py-1 bg-${line.color}-100 text-${line.color}-700 rounded-full text-xs font-bold uppercase`}>
                        {line.status}
                    </span>
                </div>
                <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="p-3 bg-gray-50 rounded-lg">
                        <div className="text-xs text-gray-500 mb-1 flex items-center"><Gauge size={12} className="mr-1" /> SPEED</div>
                        <div className="text-lg font-bold">{line.speed}</div>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                        <div className="text-xs text-gray-500 mb-1 flex items-center"><Activity size={12} className="mr-1" /> OEE</div>
                        <div className="text-lg font-bold">{line.oee}</div>
                    </div>
                </div>
                {/* Live Metrics */}
                <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                        <span className="text-gray-500 flex items-center"><Thermometer size={14} className="mr-2" /> Temperature</span>
                        <span className="font-mono font-medium">115°C</span>
                    </div>
                    <div className="flex justify-between text-sm">
                        <span className="text-gray-500 flex items-center"><Droplet size={14} className="mr-2" /> Humidity</span>
...
const QualityControlView = () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fadeIn">
        ...
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-xl shadow border border-gray-200 flex items-center">
                <div className="p-3 bg-green-100 rounded-full mr-4"><CheckCircle className="text-green-600" /></div>
                <div>
            ...
            <div className="bg-white p-4 rounded-xl shadow border border-gray-200 flex items-center">
                <div className="p-3 bg-red-100 rounded-full mr-4"><AlertTriangle className="text-red-600" /></div>
                <div>
                    <div className="text-sm text-gray-500">Defects Today</div>
                    <div className="text-2xl font-bold text-gray-900">14</div>
                </div>
            </div>
            <div className="bg-white p-4 rounded-xl shadow border border-gray-200 flex items-center">
                <div className="p-3 bg-blue-100 rounded-full mr-4"><ClipboardList className="text-blue-600" /></div>
                <div>
                    <div className="text-sm text-gray-500">Batches Checked</div>
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Recent Inspection Logs
            </h2>
            <table className="w-full text-sm text-left">
                <thead className="bg-gray-50 text-gray-500">
                    <tr>
                ...
                <tbody className="divide-y divide-gray-100">
                    <tr>
                        ...
                        <td className="p-3 text-green-600 font-bold">PASS</td>
                        <td className="p-3">A. Singh</td>
                    </tr>
                    <tr>
                        <td className="p-3 font-mono">#B-993</td>
                        <td className="p-3">11:15 AM</td>
                        <td className="p-3 text-green-600 font-bold">PASS</td>
                        <td className="p-3">M. Lee</td>
                    </tr>
                    <tr>
                        <td className="p-3 font-mono">#B-994</td>
                        <td className="p-3">11:45 AM</td>
                        <td className="p-3 text-red-500 font-bold">FAIL (Thickness)</td>
                        <td className="p-3">A. Singh</td>
                    </tr>
                </tbody>
            </table>
        ...
        <div className="bg-yellow-50 rounded-xl border border-yellow-200 p-6">
            <div className="flex items-center mb-2 text-yellow-800 font-bold">
                <AlertTriangle size={20} className="mr-2" /> QC Alert
            </div>
            <p className="text-sm text-yellow-700 mb-4">
                Batch #B-994 flagged for thickness variation (+0.05mm). Line A calibration recommended.
            </p>
            <button className="w-full py-2 bg-white border border-yellow-300 text-yellow-700 font-medium rounded shadow-sm hover:bg-yellow-100 text-sm">
                View Defect Report
            </button>
        </div>
    </div>
...
const MaintenanceView = () => (
    <div className="grid grid-cols-1 gap-6 animate-fadeIn">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h2 className="text-lg font-bold text-gray-900 mb-4">Machine Health Status</h2>
                <div className="space-y-4">
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <span className="text-sm font-medium">Dipping Machine A1</span>
                            <span className="text-xs font-bold text-green-600 bg-green-100 px-2 py-0.5 rounded">GOOD (92%)</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <span className="text-sm font-medium">Curing Oven B</span>
                            <span className="text-xs font-bold text-yellow-600 bg-yellow-100 px-2 py-0.5 rounded">FAIR (74%)</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            <span className="text-sm font-medium">Hydraulic Press 4</span>
                            <span className="text-xs font-bold text-green-600 bg-green-100 px-2 py-0.5 rounded">GOOD (98%)</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
            ...
            {/* Upcoming Schedule */}
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h2 className="text-lg font-bold text-gray-900 mb-4">Scheduled Maintenance
                </h2>
                <div className="space-y-4">
                    <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
                        <Calendar className="text-blue-500 flex-shrink-0 mt-1" size={18} />
                        <div>
                            <div className="text-sm font-bold text-gray-900">Line B: Full Service</div>
                            <div className="text-xs text-gray-500">Scheduled: Nov 28, 2025 • 08:00 AM</div>
                            <div className="text-xs text-blue-600 mt-1 font-medium">Tech: R. Sharma</div>
                        </div>
                    </div>
                    <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg border border-gray-100">
                        <Wrench className="text-gray-400 flex-shrink-0 mt-1" size={18} />
                        <div>
                            <div className="text-sm font-bold text-gray-900">Filter Replacement (All Lines)</div>
                            <div className="text-xs text-gray-500">Scheduled: Dec 05, 2025</div>
                        </div>
                    </div>
                </div>
            </div>
...
const ProductionDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
            ...
            {/* Header */}
            <header className="bg-white shadow-sm h-16 sticky top-0 z-30">
                <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
                    <a href="#" className="flex items-center space-x-2 text-blue-500 hover:text-blue-700 transition-colors">
                        <ArrowLeft className="w-5 h-5" />
                        <span className="text-sm font-medium">Back to Dashboard</span>
                    </a>
                    <h1 className="text-lg font-semibold">Production Planning</h1>
                    <div className="flex items-center space-x-6">
                        <div className="relative">
                            <Bell className="w-6 h-6 text-gray-500" />
                            <span className="absolute -top-2 -right-2 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs font-bold text-white">1</span>
                        </div>
                        <div className="flex items-center space-x-2">
                            <img className="h-9 w-9 rounded-full object-cover" src="https://placehold.co/40x40/E0E7FF/1E40AF?text=RK" alt="Avatar" />
            ...
            {/* Context Bar */}
            <div className="bg-gray-50 h-16 border-b border-gray-200 flex items-center sticky top-16 z-20">
                <div className="max-w-7xl mx-auto px-6 w-full">
                    <p className="text-sm text-gray-500">
                        <span className="text-xl align-middle mr-2">📋</span>
                        <span className="font-medium text-gray-900">Planning for:</span> VivaLife Distributors • 7,00,000 Sterile Medical Gloves • 6 month delivery
                    </p>
                </div>
            </div>

            {/* Navigation Tabs */}
            <nav className="bg-white h-14 border-b border-gray-200 shadow-sm sticky top-32 z-20 overflow-x-auto no-scrollbar">
                <div className="max-w-7xl mx-auto px-6 h-full flex items-center space-x-8">
                    {tabs.map((tab, index) => (
                        <button
                            key={index}
                            onClick={() => {
                            ...
                            className={`text-sm font-medium h-full flex items-center border-b-2 transition-colors whitespace-nowrap px-1 ${activeTab === index
                        ...
                        >
                            ...
                            {activeTab === index && !isPaused && (
                                <span className="ml-2 w-1.5 h-1.5 bg-blue-600 rounded-full animate-pulse"></span>
                            )}
                        </button>
                    ))}
                </div>
            ...
            <main
                className="p-6 lg:p-8 max-w-7xl mx-auto min-h-[600px]"
            ...
            >
                ...
                <div className="fixed bottom-4 right-4 text-xs text-gray-400 bg-white/80 p-2 rounded shadow backdrop-blur-sm pointer-events-none">
