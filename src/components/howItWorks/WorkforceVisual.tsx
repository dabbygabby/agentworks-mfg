...
const WorkforceVisual = () => {
    ...
    return (
        <div className="bg-gray-50 rounded-3xl p-4 md:p-6 shadow-xl border border-gray-100 relative overflow-hidden h-auto min-h-[660px] md:h-[660px] w-full flex flex-col font-sans">
            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex-1 flex flex-col gap-4 md:gap-6">
                    ...
                    {/* Agents Grid - Responsive Change Here */}
                    {/* grid-cols-1 for mobile, sm:grid-cols-2 for everything larger */}
