          ...
          `}
           ...
           ============================================= */}
                <g transform="translate(50, 0)">
                    ...
                    {/* Input 1: Tally */}
                    <g className="icon-hover" transform={`translate(0, ${centerY - inputSpacing * 1.5})`}>
                        <rect x="0" y="-30" width="80" height="60" rx="12" fill="#166534" filter="url(#softShadow)" />
                        <g transform="translate(40, 0)" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <ellipse cx="0" cy="-6" rx="12" ry="5" />
                            <path d="M-12 -6 V 6 C -12 11 12 11 12 6 V -6" />
                            <path d="M-12 6 V 18 C -12 23 12 23 12 18 V 6" />
                        </g>
                    </g>

                    {/* Input 2: Excel */}
                    <g className="icon-hover" transform={`translate(0, ${centerY - inputSpacing * 0.5})`}>
                        <rect x="0" y="-30" width="80" height="60" rx="12" fill="#15803d" filter="url(#softShadow)" />
                    ...
                    {/* Input 3: Email */}
                    <g className="icon-hover" transform={`translate(0, ${centerY + inputSpacing * 0.5})`}>
                        <rect x="0" y="-30" width="80" height="60" rx="12" fill="#0369a1" filter="url(#softShadow)" />
                        <g transform="translate(28, -12)" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <rect width="24" height="20" y="2" rx="2" />
                            <path d="M2 4l12 8 12-8" />
                        </g>
                    </g>
           ...
           ============================================= */}
                <g transform={`translate(330, ${centerY})`}>
                    ...
                    {/* Width 60px, Offset -30px to center it */}
                    ...
                    <text x="0" y="75" textAnchor="middle" fill="#64748b" fontSize="13" fontWeight="600">Whatsapp Bridge</text>
                </g>
           ...
           ============================================= */}
                <g transform={`translate(450, ${centerY - 150})`}>
                    <rect x="0" y="0" width="200" height="270" rx="16" fill="#f8fafc" stroke="#e2e8f0" strokeWidth="2" />
                    <text x="20" y="30" fill="#94a3b8" fontSize="12" fontWeight="600" letterSpacing="0.5">AI Engine</text>

                    <g transform="translate(16, 45)"> {/* Shifted content down slightly */}
                        {/* Voice */}
                        <g className="icon-hover">
                            <Mic className='text-gray-500' />
                            <text x="28" y="14" fontSize="13" fill="#334155">Voice Notes</text>
                        </g>
                        {/* Text */}
                        <g transform="translate(0, 45)" className="icon-hover">
                            <MessageCircle className='text-gray-500' />
                            <text x="28" y="14" fontSize="13" fill="#334155">Text Messages</text>
                        </g>
                        {/* Images */}
                        <g transform="translate(0, 90)" className="icon-hover">
                            <Image className='text-gray-500' />
                            <text x="28" y="14" fontSize="13" fill="#334155">Images</text>
                        </g>
                        {/* Bills */}
                        <g transform="translate(0, 135)" className="icon-hover">
                            <File className='text-gray-500' />
                            <text x="28" y="14" fontSize="13" fill="#334155">Bills & Files</text>
                        </g>
                        {/* Location */}
                        <g transform="translate(0, 180)" className="icon-hover">
                            <MapPin className='text-gray-500' />
                            <text x="28" y="14" fontSize="13" fill="#334155">Location</text>
                        </g>
                    </g>
                </g>
            ...
            SECTION 4: DATABASE
           ============================================= */}
                <g transform={`translate(750, ${centerY})`} className="icon-hover">
           ...
           ============================================= */}
                <g transform="translate(900, 0)">
                    {/* Agent 1: Quoting */}
                    <g className="icon-hover" transform={`translate(0, ${centerY - outputSpacing * 1.5})`}>
                    ...
                    {/* Agent 2: Inventory */}
                    <g className="icon-hover" transform={`translate(0, ${centerY - outputSpacing * 0.5})`}>
                    ...
                    {/* Agent 5: Many More */}
                    <g className="icon-hover" transform={`translate(0, ${centerY + outputSpacing * 2.5})`}>
