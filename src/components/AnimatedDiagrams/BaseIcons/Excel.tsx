export const Excel = (
    ...
    return (
        <g transform={`translate(0, ${centerY - inputSpacing * 0.5})`}>
            <rect x="0" y="-30" width="80" height="60" rx="12" fill="white" stroke="#e2e8f0" strokeWidth="1" filter="url(#softShadow)" />
            <svg x="15" y="-23" width="50" height="46" viewBox="0 0 2289.75 2130">
                <defs>
                    <linearGradient id="excelGradient" gradientUnits="userSpaceOnUse" x1="203.5132" y1="1729.0183" x2="967.9868" y2="404.9817" gradientTransform="matrix(1 0 0 -1 0 2132)">
                ...
                <path fill="url(#excelGradient)" d="M97.607,479.25h976.285c53.907,0,97.607,43.7,97.607,97.607v976.285c0,53.907-43.7,97.607-97.607,97.607H97.607C43.7,1650.75,0,1607.05,0,1553.143V576.857C0,522.95,43.7,479.25,97.607,479.25z" />
