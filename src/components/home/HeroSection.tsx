                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-left">
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-[#022c22] mb-6 leading-tight">
                            <span > Total Visibility </span> <br /><span className="text-[#65a30d]">Zero Data Entry</span>
                        </h1>
                        <p className="text-lg text-[#022c22]/70 mb-8 max-w-xl leading-relaxed font-medium mt-0 md:mt-28">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-start gap-4 mt-0 md:mt-52">
                            <Link
                                ...
                                className='flex flex-row justify-center items-center gap-2 bg-[#022c22] font-semibold text-white px-8 py-5 rounded-full hover:bg-[#65a30d] transition-colors'
                            >
                                Talk to an Expert
                    ...
                    <div className="relative mx-auto w-full max-w-2xl lg:max-w-none bg-[#f7fee7] p-4 pt-0 rounded-3xl">
